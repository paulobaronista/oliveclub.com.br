        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-10 col-lg-offset-1 padding-off-mobile">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand scrollink" href="#assine"><img src="<?= base_url(); ?>assets/images/logo.png" alt="Olive Clube Batalha"></a>
                </div>
                <div id="navbar" class="navbar-collapse collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li><a class="scrollink" href="#assine">Assine</a></li>
                        <li><a class="scrollink" href="#como-funciona">Como Funciona</a></li>
                        <li><a class="scrollink" href="#caixa-de-azeites">Caixa de Azeites</a></li>
                        <li><a class="scrollink" href="#vantagens">Vantagens</a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<div id="assine" class="container-fluid padding-off assine">
    <div class="galeria">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2">
                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 box">
                        <img class="img-responsive center-block" src="<?= base_url(); ?>assets/images/vantagem_01.png" alt="Olive Club Batalha">
                    </div>
                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 box">
                        <img class="img-responsive center-block" src="<?= base_url(); ?>assets/images/vantagem_02.png" alt="Olive Club Batalha">
                    </div>
                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 box">
                        <img class="img-responsive center-block" src="<?= base_url(); ?>assets/images/vantagem_03.png" alt="Olive Club Batalha">
                    </div>
                </div>
            </div>
        </div>
